-module(auctions_get_auctions_handler).
-moduledoc """
Exposes the following operation IDs:

- `GET` to `/auctions/:auctionId`, OperationId: `get_auction`:
Get a single auction.


- `GET` to `/auctions`, OperationId: `get_auctions`:
Get all auctions.
...
allowed_methods(Req, #state{operation_id = 'get_auction'} = State) ->
    {[<<"GET">>], Req, State};
...
content_types_provided(Req, #state{operation_id = 'get_auctions'} = State) ->
    {[
      {<<"text/plain">>, handle_type_provided},
      {<<"application/json">>, handle_type_provided},
      {<<"text/json">>, handle_type_provided}
